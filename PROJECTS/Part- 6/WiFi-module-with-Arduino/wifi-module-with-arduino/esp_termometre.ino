...
void loop() {
  ...
  String veri = "GET https://api.thingspeak.com/update?api_key=2F55993RWVDCTSUS";   //Thingspeak komutu. Key kısmına kendi api keyimizi yazıyoruz.                                   
  veri += "&amp;field1=";     //Göndereceğimiz sıcaklık değişkeni
